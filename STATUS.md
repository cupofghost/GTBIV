...
| 2026-07-25 | `index.html`, player/vehicle/camera/FX/dogs, Codex workflow, focused tests | Checkpoint: camera, terrain/traffic, Turbo, controls/kick/aim, and dog-count work implemented. Terra handoff in `CODEX/HANDOFF_TERRA.md`; explosion, MP3-only guard, and browser validation remain. | Signed: Codex \| GPT-5 \| high |
...
- `index.html` — 2026-07-25: consolidated camera, vehicle, player, combat, explosion, dog-lifecycle, and VO pass. Signed: Codex | GPT-5 | high
