...
|------|--------------|-------------------------|-----------|
| 2026-07-28 | `index.html` §HUD/TOASTS mission chips, §MISSIONS notifications, §TALKING PEDS speech bubbles; `tests/cases/` | **CLAIMED — OP2-E** (Card 3, `claude/op2e-mission-ui-bubbles`): quiet mission UI and bubble-tail fixes, in progress. | Signed: Claude Code \| Sonnet 5 \| medium |
